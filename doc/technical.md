...
- 游戏：Magnet Drop
- 类型：action
- 简述：Same color chains — 拖手指出一个磁铁,卷走同色粒子,串得越长爆得越响。换色?直接戳那颗就行,磁铁会自动重新调色
- 框架 / 语言 / 构建：TypeScript, Vite
- 渲染方式：Canvas/WebGL
- 依赖摘录：vite@^5.1.0
- 平台元信息：meta.title=Magnet Drop；cover_url=/poster.png；category=action；uuid=414afe34-82fe-41a6-8b16-17c175ede45a
